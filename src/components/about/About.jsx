...
const About = () => {
    return (
        <div id='about' className='w-full pt-24 bg-[#f5f5f5] text-[#111111] border-black border-t-2 '>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='max-w-[1000px] w-full grid sm:grid-cols-1 gap-10 px-4'>
                    <div className='sm:text-left text-[16px]'>
                        <p>Hello! My name is Napatsakorn. I'm a new graduated in Bachelor's degree in
                    ...
                    <div className='flex max-w-[1000px] w-full flex-wrap justify-center xl:flex-nowrap'>
                        <div>
                            <p className='px-4 py-2 sm:text-left'>I'm experienced in Data Analytics processing such as Data Wrangling, Model Training, Data Visualization, AI, Data Engineering and Web Development.
                            </p>
                            <p className='px-4 sm:text-left'>I'm joined in <span className='text-[#005eff] font-bold hover-link2 z-40'>Junior Software Developer Bootcamp at Generation Thailand.</span> I had learn about<span className='text-[#005eff] font-bold hover-link2 z-40'> MERN Stack (MongoDB, Express, React, Node)</span> and So on I will Learn about Container (Docker) and Data tools on ecosystem such as Hive, Hadoop, PostgreSQL, Airflow and keep on track on Road to Data Engineer. </p>
                        </div>
                        <div className=''>
                            <div className="containerskill2">
                                <div className="">
                                    <div className="">
                                        <h2 className=""><img src={Profile} alt="" className='max-w-[250px] mt-4  xl:max-w-[300px]' /></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
